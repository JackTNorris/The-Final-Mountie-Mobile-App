...
<html lang="en">
<head>
    <title>Code coverage report for index.ios.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> index.ios.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">77.88% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>81/104</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
export default class NotificationsIOS {<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ></span></span>
  /**
...
&nbsp;
      if (type === DEVICE_REMOTE_NOTIFICATIONS_REGISTERED_EVENT) {
        listener = DeviceEventEmitter.addListener(
          DEVICE_REMOTE_NOTIFICATIONS_REGISTERED_EVENT,
<span class="fstat-no" title="function not covered" >          re</span>gistration =&gt; handler(r<span class="cstat-no" title="statement not covered" >egistration.deviceToken)</span>
        );
      } else if (type === DEVICE_REMOTE_NOTIFICATIONS_REGISTRATION_FAILED_EVENT) {
        listener = DeviceEventEmitter.addListener(
          DEVICE_REMOTE_NOTIFICATIONS_REGISTRATION_FAILED_EVENT,
<span class="fstat-no" title="function not covered" >          er</span>ror =&gt; handler(e<span class="cstat-no" title="statement not covered" >rror)</span>
        );
      } else if (type === DEVICE_PUSH_KIT_REGISTERED_EVENT) {
        listener = DeviceEventEmitter.addListener(
          DEVICE_PUSH_KIT_REGISTERED_EVENT,
<span class="fstat-no" title="function not covered" >          re</span>gistration =&gt; handler(r<span class="cstat-no" title="statement not covered" >egistration.pushKitToken)</span>
        );
      } else {
        listener = DeviceEventEmitter.addListener(
          type,
<span class="fstat-no" title="function not covered" >          no</span>tification =&gt; handler(n<span class="cstat-no" title="statement not covered" >ew IOSNotification(notification))</span>
        );
      }
&nbsp;
...
&nbsp;
  ...
  static removeEventListener(type: string, handler: Function) {
    if (_exportedEvents.indexOf(type) !== -1) {
      ...
      if<span class="missing-if-branch" title="else path not taken" >E</span> (listener) {
        listener.remove();
...
&nbsp;
  static _actionHandlerDispatcher(action: Object) {
    const actionHandler = <span class="cstat-no" title="statement not covered" >_actionHandlers.get(action.identifier);</span>
&nbsp;
    if<span class="cstat-no" title="statement not covered" > (actionHandler) {</span>
      ac<span class="cstat-no" title="statement not covered" >tion.notification = new IOSNotification(action.notification);</span>
&nbsp;
      ac<span class="cstat-no" title="statement not covered" >tionHandler(action, ()<span class="fstat-no" title="function not covered" > =</span>&gt; {</span>
        Na<span class="cstat-no" title="statement not covered" >tiveRNNotifications.completionHandler(action.completionKey);</span>
      });
    }
  }
&nbsp;
...
&nbsp;
  ...
  static resetCategories() {
    if<span class="missing-if-branch" title="else path not taken" >E</span> (_actionListener) {
...
&nbsp;
  static log(message: string) {
    Na<span class="cstat-no" title="statement not covered" >tiveRNNotifications.log(message);</span>
  }<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ></span></span></span></span></span></span></span>
&nbsp;
  static async getInitialNotification() {
    const notification = await NativeRNNotifications.getInitialNotifi<span class="cstat-no" title="statement not covered" >cation();<span class="cstat-no" title="statement not covered" ></span></span>
    if (notification) {<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ></span></span></span>
      return new IOSNotification(notification);<span class="cstat-no" title="statement not covered" ></span>
    } else {
      return undefined;<span class="cstat-no" title="statement not covered" ></span>
    }
  }
&nbsp;
  /**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sun Jul 07 2019 18:12:20 GMT+0300 (Israel Daylight Time)
</div>
</div>
