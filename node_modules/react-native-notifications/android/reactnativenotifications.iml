...
<module external.linked.project.id=":reactnativenotifications" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../wix-one-app-engine/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":reactnativenotifications" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager">
    ...
    <orderEntry type="library" name="Gradle: com.facebook.react:react-native:0.57.508@aar" level="project" />
    ...
    <orderEntry type="library" scope="TEST" name="Gradle: org.mockito:mockito-core:2.24.0@jar" level="project" />
