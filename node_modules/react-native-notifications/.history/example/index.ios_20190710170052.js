...
class NotificationsExampleApp extends Component {
  ...
  onNotificationReceivedForeground(notification, completion) {
    console.log('Notification Received Foreground with title: ' + JSON.stringify(notification.getMessage()));
    this.setState({
      notifications: [...this.state.notifications, notification.getMessage().body]
    });
