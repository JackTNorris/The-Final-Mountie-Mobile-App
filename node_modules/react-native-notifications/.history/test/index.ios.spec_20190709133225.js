describe('NotificationsIOS', () => {
  ...
  beforeEach(() => {
    ...
    NativeAppEventEmitter = require('react-native').NativeModules.RNBridgeModule;
  ...
  describe('Add Event Listener', () => {
    deviceEvents.forEach(event => {
      it(`should subscribe the given handler to device event: ${event}`, () => {
        ...
        expect(nativeModule.DeviceEventEmitter).toHaveBeenCalledWith(event, expect.any(Function));
      });
    });
