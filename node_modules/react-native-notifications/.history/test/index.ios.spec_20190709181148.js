describe('NotificationsIOS', () => {
  ...
  describe('Remove Event Listener', () => {
    ...
    it('should listen to foreground notifications', () => {
      const handler = jest.fn();
      NotificationsIOS.addEventListener('notificationReceivedForeground', someHandler);
      NotificationsIOS.removeEventListener('notificationReceivedForeground', someHandler);
