describe('Notifications-Android > ', () => {
  ...
  beforeEach(() => {
    ...
    reactNativeMock = jest.mock('react-native', () => {
      return {
        NativeModules: {
          WixRNNotifications: {
    ...
    libUnderTest = jest.mock('../lib/src/index.android');
    // libUnderTest = proxyquire('../lib/src/index.android', {
    //   'react-native': {
    //     NativeModules: {
    //       WixRNNotifications: {
    //         refreshToken: refreshTokenStub,
    ...
    //     }
    //   },
    //   './notification': require('../lib/src/notification.android')
    // });
  });

  describe('Registration token API', () => {
    it.only('should assign callback to native event upon listener registration', () => {
      expect(deviceEventEmitterListenerStub).toHaveBeenCalledsTimes(0);
      const userListener = () => {};
