...
describe('Notifications', () => {
  ...
  describe('Foreground notifications', () => {
    ...
    it('Receive foreground notification', async () => {
      await device.sendUserNotification(createNotification('explicit/external/link/test_parameter', 'this is alert'));
      await expect(elementByLabel('this is alert')).toBeVisible();
...
function createNotification(link, alert) {
  return {
    trigger: {
      type: 'push'
    },
