...
describe('Notifications', () => {
  ...
  it('switch to tab by index', async () => {
    await device.launchApp({newInstance: true, userNotification: getNotification('unknown/link', businessId1, 'test/category', {parameter: 'test_body_param'})});
...
function getNotification(link, metaSiteId, category = 'com.example.category', params = {}) {
  return {
    trigger: {
      type: 'push'
    },
