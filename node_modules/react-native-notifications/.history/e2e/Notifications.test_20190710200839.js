...
describe('Notifications', () => {
  describe('Foreground', () => {
    ...
    it('Click notification', async () => {
      await device.sendUserNotification(createNotification('foreground/notification/click'));
      // await expect(elementByLabel('foreground/notification')).toBeVisible();
    });
  });
  ...
  describe('Background', () => {
    ...
    it('Receive notification', async () => {
      device.sendToHome();
      device.launchApp({newInstance: false, userNotification: createNotification('background/notification')});
      await expect(elementByLabel('background/notification')).toBeVisible();
    });
  });

  describe('Dead state', () => {
    it.only('Receive notification', async () => {
      await device.launchApp({newInstance: true, userNotification: createNotification('deadState/notification')});
